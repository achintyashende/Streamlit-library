...
df = pd.read_csv("C:/Users/achin/.streamlit/lang_data.csv")
lst = df.columns.tolist()
lang_choices = st.multiselect('Choose your language', lst)
...
df = pd.read_csv('C:/Users/achin/.streamlit/tips.csv')
